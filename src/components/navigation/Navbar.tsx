...
const Navbar = () => {
  return (
    <nav className="py-4 bg-transparent sticky top-0 backdrop-blur-2xl z-50 px-[5vw] sm:px-[3.5vw] lg:px-[3vw]">
      <div className="flex justify-between w-full max-w-[1550px] mx-auto items-center">
        ...
        <Button className="hidden text-xl bg-Green-100 hover:bg-Green-300 text-White-100 h-11 xl:flex justify-between items-center p-4 gap-2">
