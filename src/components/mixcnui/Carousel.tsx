...
>(({ className, index, children, ...props }, ref) => {
	...
	return (
		<div
			...
			className={cn(
				'flex min-w-0 shrink-0 grow-0 basis-1/3 md:basis-1/4 bg-background p-1',
				`${orientation === 'vertical' ? 'pb-1' : 'pr-1'}`,
				className
			)}
		>
			<div
				className={`relative aspect-square h-[100px] w-full opacity-40 rounded-md transition-opacity ${
