						...
						<CarouselContent className=' '>
							{values.map((item, i) => (
								<CarouselItem
									...
									key={i}
								>
									<div className=' gap-4 w-full flex flex-col justify-between flex-shrink-0' key={i}>
										<h1 className=' text-2xl md:text-3xl uppercase font-bold'>{item.heading}</h1>
										<h3>
											We understand that each individual&apos;s health journey is unique. That&apos;s why we work
											closely with you to develop a tailored treatment plan that addresses your specific needs and
											goals.
										</h3>
