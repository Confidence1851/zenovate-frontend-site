    ...
    <section className="bg-White-100-100 space-y-24 pb-20 lg:pb-40">
      <div className="w-full max-w-[1550px] mx-auto px-2 space-y-20">
        ...
        <p className="text-base lg:text-xl text-Black-100">
          Explore our selection of premium health products that have been
          carefully curated to support your wellness journey. Each item is
          chosen for its quality and effectiveness, ensuring you receive the
          best possible support for your health goals.
        </p>
