      ...
      <div className="max-w-[1550px] mx-auto px-2 space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {howItWorks.map((item, i) => (
            <div
              className="border border-Black-100 p-8 md:p-10 flex flex-col justify-between gap-10 md:gap-16"
              key={i}
            >
              <h2 className="text-2xl lg:text-5xl text-Green-100 uppercase font-semibold">
                {item.heading}
              </h2>
