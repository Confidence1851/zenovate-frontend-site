            ...
            <CarouselContent>
                {slides.map((slide, index) => (
                    <CarouselItem key={index}>
                        <section className="relative h-[calc(100dvh-60px)] sm:max-h-[600px] xl:max-h-fit bg-Gray-200">
                            <div className="absolute z-20 top-0 left-0 h-full w-full bg-Green-100 opacity-10"></div>

                            <div className="w-full relative z-30 max-w-7xl mx-auto h-full flex justify-end flex-col pb-16 md:pb-[6rem] lg:pb-40 px-[5vw] sm:px-[3.5vw] lg:px-[3vw]">
