...
const PageHeroWrapper: React.FC<PageHeroWrapperProps> = ({ description, heading, coloredHeading, image }) => {
	return (
		<section className={styles.section}>
			...
			<div className='relative w-full max-w-[1550px] mx-auto h-full flex justify-end flex-col pb-10 sm:pb-16 '>
				<div className='w-full max-w-[750px] flex flex-col gap-3 md:gap-5'>
					...
					<p className='text-Black-100 text-base lg:text-xl lg:leading-8'>{description}</p>
				</div>
			</div>
		</section>
	)
