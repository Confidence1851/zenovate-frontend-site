...
import { calculateCartSummary, CartSummary, initOrderSheetCheckout, processDirectCheckout } from '@/server-actions/directCheckout.actions';
...
export function CartSidebar({ open, onOpenChange }: CartSidebarProps) {
  ...
  const handleCustomerFormSubmit = async () => {
    ...
    try {
      ...
      // Initialize checkout
      const checkout = await initOrderSheetCheckout({
        products,
      ...
      if (result.redirect_url) {
        // Clear cart and close sidebar before redirect
        clearCart();
        onOpenChange(false);
