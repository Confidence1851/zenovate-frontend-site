export default function Wrapper({ children, heading, mobParagraph, paragraph, customHeading = false }: Readonly<{
    ...
    return (
        <div className='grid min-h-[calc(100svh-73px)] px-[5vw] sm:px-[3vw] xl:px-0 grid-cols-1 xl:grid-cols-[58%,42%]'>
            <div className='hide-scrollbar pt-9 pb-7 flex items-center justify-start'>
