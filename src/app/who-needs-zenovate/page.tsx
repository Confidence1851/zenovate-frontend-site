    ...
    <main>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1100px] mx-auto">
            {cardDetails.map((item, i) => (
              ...
              >
                ...
                <div className="bg-gradient-to-t  from-Black-100 to-OffWhite-100 p-6 flex flex-col justify-between min-h-[200px]">
      ...
      <section className="bg-Green-200 py-6">
        <div className="w-full max-w-[1550px] mx-auto flex justify-between items-center  px-2">
          <p className="uppercase text-Green-100 text-xl font-semibold">
